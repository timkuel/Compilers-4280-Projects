...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /*  Starting the parser, the root node will be returned by the parser
         *  and used to initialized the static semantics check */
        SemanticsCheck checkSemantics = new SemanticsCheck(parser.startParser());
        ...
        System.out.println("\nDone checking the static semantics...Program Successful");      
